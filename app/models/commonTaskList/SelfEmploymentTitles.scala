...
object SelfEmploymentTitles {
  ...
  val values: List[TaskTitle] = List(
    TradeDetails(), // TODO 8771 should trade details be excluded?
  ...
  case class TradeDetails() extends WithName("TradeDetailsTitle") with TaskTitle
  object TradeDetails {
  ...
  case class SelfEmploymentAbroad() extends WithName("SelfEmploymentAbroadTitle") with TaskTitle {
  ...
  case class Income() extends WithName("IncomeTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class ExpensesTailoring() extends WithName("ExpensesTailoringTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class GoodsToSellOrUse() extends WithName("GoodsToSellOrUseTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class WorkplaceRunningCosts() extends WithName("WorkplaceRunningCostsTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
      if (toCYA) s"/$taxYear/$businessId/expenses/workplace-running-costs/workplace-running-costs/check"
      else
        s"$taxYear/$businessId/expenses/workplace-running-costs/working-from-home/more-than-25-hours" // TODO 8773 add logic to determine whether this should be WFH or WFBP
  }
  ...
  case class RepairsAndMaintenanceCosts() extends WithName("RepairsAndMaintenanceCostsTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class AdvertisingOrMarketing() extends WithName("AdvertisingOrMarketingTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class OfficeSupplies() extends WithName("OfficeSuppliesTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class Entertainment() extends WithName("EntertainmentTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class StaffCosts() extends WithName("StaffCostsTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class Construction() extends WithName("ConstructionTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class ProfessionalFees() extends WithName("ProfessionalFeesTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class Interest() extends WithName("InterestTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class OtherExpenses() extends WithName("OtherExpensesTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class FinancialCharges() extends WithName("FinancialChargesTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class IrrecoverableDebts() extends WithName("IrrecoverableDebtsTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class Depreciation() extends WithName("DepreciationTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class CapitalAllowancesTailoring() extends WithName("CapitalAllowancesTailoringTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class ZeroEmissionCars() extends WithName("ZeroEmissionCarsTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class ZeroEmissionGoodsVehicle() extends WithName("ZeroEmissionGoodsVehicleTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class ElectricVehicleChargePoints() extends WithName("ElectricVehicleChargePointsTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class BalancingAllowance() extends WithName("BalancingAllowanceTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class WritingDownAllowance() extends WithName("WritingDownAllowanceTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class AnnualInvestmentAllowance() extends WithName("AnnualInvestmentAllowanceTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
      if (toCYA) s"/$taxYear/$businessId/capital-allowances/check"
  ...
  case class SpecialTaxSites() extends WithName("SpecialTaxSitesTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
  ...
  case class StructuresBuildings() extends WithName("StructuresBuildingsTitle") with TaskTitle {
    override def getHref(taxYear: TaxYear, businessId: BusinessId, toCYA: Boolean): String =
