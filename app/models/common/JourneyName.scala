...
object JourneyName extends Enum[JourneyName] with utils.PlayJsonEnum[JourneyName] {
  ...
  case object CapitalAllowancesZeroEmissionCars         extends JourneyName("capital-allowances-zero-emission-cars")
  case object CapitalAllowancesZeroEmissionGoodsVehicle extends JourneyName("capital-allowances-zero-emission-goods-vehicle")
