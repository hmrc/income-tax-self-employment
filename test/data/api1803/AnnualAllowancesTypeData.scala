...
package data.api1803

import models.connector.api_1803.{AnnualAllowancesType, StructuredBuildingAllowanceTypeInner, StructuredBuildingAllowanceTypeInnerBuilding}

object AnnualAllowancesTypeData {
  val example: AnnualAllowancesType = AnnualAllowancesType(
    ...
    enhancedStructuredBuildingAllowance = Some(
      List(
        StructuredBuildingAllowanceTypeInner(
          1.0,
          None,
          StructuredBuildingAllowanceTypeInnerBuilding(Some("name"), None, "postCode")
        )
      )),
