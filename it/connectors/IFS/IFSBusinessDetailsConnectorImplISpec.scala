...
class IFSBusinessDetailsConnectorImplISpec extends IntegrationBaseSpec {
  ...
  "getBusinessIncomeSourcesSummary" must {
    "return successful response" in new Api1871Test {
      ...
      connector.getBusinessIncomeSourcesSummary(testTaxYear, testNino, testBusinessId).value.futureValue shouldBe Right(api1171Response)
    }
  }
  ...
  "createBroughtForwardLoss" must {
    "return successful response" in new Api1500Test {
      ...
      connector.createBroughtForwardLoss(data).value.futureValue shouldBe api1171Response.asRight
    }
  }
  ...
  "updateBroughtForwardLoss" must {
    "return successful response" in new Api1501Test {
      ...
      connector.updateBroughtForwardLoss(data).value.futureValue shouldBe api1171Response.asRight
    }
  }
  ...
  "getBroughtForwardLoss" must {
    "return successful response" in new Api1502Test {
      ...
      connector.getBroughtForwardLoss(testNino, testBusinessId.value).value.futureValue shouldBe api1171Response.asRight
    }
  }
  ...
  "listBroughtForwardLoss" must {
    "return successful response" in new Api1870Test {
      ...
      connector.listBroughtForwardLosses(testNino, testTaxYear).value.futureValue shouldBe api1171Response.asRight
    }
  }
  ...
  "listOfIncomeSources" must {
    "return successful response" in new Api2085Test {
      ...
      connector.getListOfIncomeSources(testTaxYear, testNino).value.futureValue shouldBe api1171Response.asRight
    }
